...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x70, 0x63, 0x64, 0x65, 0x6d, 0x6f, 0x22, 0x46, 0x0a, 0x0c,
	...
	0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0x45, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	0x12, 0x14, 0x2e, 0x70, 0x63, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x70, 0x63, 0x64, 0x65, 0x6d, 0x6f, 0x2e,
...
var file_auth_service_proto_goTypes = []interface{}{
	(*LoginRequest)(nil),  // 0: pcdemo.LoginRequest
	(*LoginResponse)(nil), // 1: pcdemo.LoginResponse
}
var file_auth_service_proto_depIdxs = []int32{
	0, // 0: pcdemo.AuthService.Login:input_type -> pcdemo.LoginRequest
	1, // 1: pcdemo.AuthService.Login:output_type -> pcdemo.LoginResponse
...
func (c *authServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pcdemo.AuthService/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pcdemo.AuthService/Login",
	}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pcdemo.AuthService",
