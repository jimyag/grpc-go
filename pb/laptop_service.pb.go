...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x32, 0xab, 0x01, 0x0a, 0x0d, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x6f, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x05,
...
var file_laptop_service_proto_goTypes = []interface{}{
	...
	(*Laptop)(nil),               // 4: pcdemo.Laptop
	(*Filter)(nil),               // 5: pcdemo.Filter
}
var file_laptop_service_proto_depIdxs = []int32{
	4, // 0: pcdemo.CreateLaptopRequest.laptop:type_name -> pcdemo.Laptop
	5, // 1: pcdemo.SearchLaptopRequest.filter:type_name -> pcdemo.Filter
	4, // 2: pcdemo.SearchLaptopResponse.laptop:type_name -> pcdemo.Laptop
	0, // 3: pcdemo.LaptopService.CreateLaptop:input_type -> pcdemo.CreateLaptopRequest
	2, // 4: pcdemo.LaptopService.SearchLaptop:input_type -> pcdemo.SearchLaptopRequest
	1, // 5: pcdemo.LaptopService.CreateLaptop:output_type -> pcdemo.CreateLaptopResponse
	3, // 6: pcdemo.LaptopService.SearchLaptop:output_type -> pcdemo.SearchLaptopResponse
